	...
	operations = [
		migrations.CreateModel(
			...
			fields=[
				...
				('pub_time', models.DateTimeField(blank=True, db_index=True, null=True, verbose_name='Publication time')),
				('attachments', django_attachments.fields.LibraryField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='django_attachments.library', verbose_name='Attachments')),
				('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Author')),
				('gallery', django_attachments.fields.GalleryField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='django_attachments.library', verbose_name='Gallery')),
			],
			options={
		...
		migrations.CreateModel(
			...
			fields=[
				...
				('processed_content', models.TextField(blank=True, editable=False, verbose_name='Content')),
